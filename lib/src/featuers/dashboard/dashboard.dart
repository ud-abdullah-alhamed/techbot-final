  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [IconButton(onPressed: ()=>AuthenticationRepository().logout(), icon: const Icon(Icons.logout_outlined))],
      ),
              ...
              return ListTile(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => UserReviewsPage(email:user['Email'] ),
                    ),
                  );
                },
              );
